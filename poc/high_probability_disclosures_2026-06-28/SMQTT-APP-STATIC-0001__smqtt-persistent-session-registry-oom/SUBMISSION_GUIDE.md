# Submission Guide: SMQTT-APP-STATIC-0001
...
- `attachments/SMQTT-APP-STATIC-0001.log.gz`
- `attachments/ATTACHMENTS.md`

Suggested subject:

`[Security] Denial of Service in quickmsg/smqtt: Anonymous persistent MQTT sessions retain client registry entries after disconnect`
