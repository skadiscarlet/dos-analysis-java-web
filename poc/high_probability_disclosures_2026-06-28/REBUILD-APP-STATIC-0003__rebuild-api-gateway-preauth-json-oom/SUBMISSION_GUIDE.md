# Submission Guide: REBUILD-APP-STATIC-0003
...
- `attachments/REBUILD-APP-STATIC-0003.log.gz`
- `attachments/ATTACHMENTS.md`

Suggested subject:

`[Security] Denial of Service in getrebuild/rebuild: Unauthenticated API gateway parses raw JSON before signature verification`
