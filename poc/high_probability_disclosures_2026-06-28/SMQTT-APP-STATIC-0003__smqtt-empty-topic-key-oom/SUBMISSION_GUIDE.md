# Submission Guide: SMQTT-APP-STATIC-0003
...
- `attachments/SMQTT-APP-STATIC-0003.log.gz`
- `attachments/ATTACHMENTS.md`

Suggested subject:

`[Security] Denial of Service in quickmsg/smqtt: Publishing to never-subscribed topics creates empty global topic keys`
