# Submission Guide: SMQTT-APP-STATIC-0006
...
- `attachments/SMQTT-APP-STATIC-0006.log.gz`
- `attachments/ATTACHMENTS.md`

Suggested subject:

`[Security] Denial of Service in quickmsg/smqtt: QoS2 half-handshake retains publish messages and retry ack state`
