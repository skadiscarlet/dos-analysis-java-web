# Submission Guide: POWERJOB-APP-STATIC-0002

## Where to Report

Primary target: `PowerJob/PowerJob` (https://github.com/PowerJob/PowerJob)

Direct reporting links:

- GitHub private vulnerability report, if enabled: https://github.com/PowerJob/PowerJob/security/advisories/new
- GitHub Security tab: https://github.com/PowerJob/PowerJob/security
- GitHub security policy page: https://github.com/PowerJob/PowerJob/security/policy
- Public issues fallback, contact request only and no PoC details: https://github.com/PowerJob/PowerJob/issues
- CNVD later-stage coordination: https://www.cnvd.org.cn/

Project-specific private contact:

- Tidelift coordinated disclosure: https://tidelift.com/security
- Maintainer private email from `SECURITY.md`: tengjiqi@gmail.com
...
- `attachments/POWERJOB-APP-STATIC-0002.log.gz`
- `attachments/ATTACHMENTS.md`

Suggested subject:

`[Security] Denial of Service in PowerJob/PowerJob: Pre-auth request body caching copies ordinary POST bodies into heap under default server heap`
