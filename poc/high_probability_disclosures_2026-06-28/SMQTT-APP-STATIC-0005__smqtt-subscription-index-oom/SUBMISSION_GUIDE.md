# Submission Guide: SMQTT-APP-STATIC-0005
...
- `attachments/SMQTT-APP-STATIC-0005.log.gz`
- `attachments/ATTACHMENTS.md`

Suggested subject:

`[Security] Denial of Service in quickmsg/smqtt: Anonymous subscriptions grow global fixed/wildcard topic indexes without per-client quotas`
