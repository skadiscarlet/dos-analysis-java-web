# Submission Guide: SMQTT-APP-STATIC-0002
...
- `attachments/SMQTT-APP-STATIC-0002.log.gz`
- `attachments/ATTACHMENTS.md`

Suggested subject:

`[Security] Denial of Service in quickmsg/smqtt: Anonymous retained MQTT publishes fill an unbounded in-memory retainMessages map`
