# Submission Guide: JMQTT-APP-STATIC-0002

## Where to Report

Primary target: `Cicizz/jmqtt` (https://github.com/Cicizz/jmqtt)

Direct reporting links:

- GitHub private vulnerability report, if enabled: https://github.com/Cicizz/jmqtt/security/advisories/new
- GitHub Security tab: https://github.com/Cicizz/jmqtt/security
- GitHub security policy page: https://github.com/Cicizz/jmqtt/security/policy
- Public issues fallback, contact request only and no PoC details: https://github.com/Cicizz/jmqtt/issues
...
- `attachments/JMQTT-APP-STATIC-0002.log.gz`
- `attachments/ATTACHMENTS.md`

Suggested subject:

`[Security] Denial of Service in Cicizz/jmqtt: 匿名 QoS2 PUBLISH 半握手保留 DeviceMessage`
