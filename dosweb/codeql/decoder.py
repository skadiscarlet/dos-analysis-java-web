...
QUERY_SPECS: Final[Mapping[str, QuerySpec]] = MappingProxyType(
    {
        "entries": _spec(
            ...
            enums={
                ...
                "registration_kind": frozenset({"annotation_mapping", "static_registration", "pipeline_registration", "subscription_registration", "dynamic_unresolved"}),
                "auth_context": frozenset({"unauthenticated", "low_privilege", "privileged", "unknown"}),
                "attacker_input_kind": frozenset({"request_body", "request_parameter", "path_parameter", "header", "message_payload", "stream", "unknown"}),
